  ...
  return (
    <div className="fixed backdrop-blur-[6px] left-0 top-0 z-30 w-screen h-screen flex items-center justify-center">
      ...
      <div className=" relative bg-white rounded-2xl mx-auto p-8">
        ...
        ></div>
        <h1 className="text-2xl font-semibold mb-6 text-zinc-600">Create Post</h1>
        <form
          onSubmit={handleSubmit}
          encType="multipart/form-data"
          className="flex flex-col items-center"
        >
          <div className="flex  w-[60vw] gap-6">
            ...
            <div className="md:col-span-2 w-[30vw]">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="mt-1 text-zinc-600 p-3 w-full rounded-md border border-gray-500 shadow-sm focus:ring-1"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="mt-1">
                  ...
                  <textarea
                    ...
                    name="content"
                    rows="10"
                    className="p-2 block text-zinc-600 w-full rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="border border-gray-300 rounded-lg p-4">
                ...
                <div className="mt-2 px-4 box-border flex flex-col space-y-3 justify-center items-center border-dashed border-2 border-gray-300 rounded-md py-8">
                  <input onChange={handleContent} type="file" name="image" className="text-black-100" />
                </div>
              </div>
          ...
          <button type="submit" className="text-zinc-600 bg-pink-500 px-16 py-3 rounded-xl">
            Create
          </button>
        </form>
      </div>

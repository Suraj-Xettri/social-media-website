...
const Top = () => {
  ...
  return (
    <div className="absolute bg-black opacity-90 backdrop:blur z-20 flex border-b items-center box-border border-zinc-500 text-white w-full h-14 justify-evenly">

...
const Nav = () => {
  return (
    <div className="w-screen h-16 flex bg-black justify-between items-center sm:px-4 lg:px-10 absolute backdrop:blur-xl">
      <div className="text-white text-2xl p-2 lg:text-4xl flex gap-6 justify-center items-center">
        ...
        <div className="flex items-center relative">
          <input
            ...
            className="px-4 hidden sm:flex md:py-[10px] text-sm w-[20vw] border-zinc-400 focus:outline-none focus:border-[3px] focus:border-blue-200"
          />
